...
B_ed = Button(tk, text="Изменить", font = 'Arial, 13', command = lambda: edit_data(tree, L_iid, E_sn, E_n, E_mn, E_db, E_s, B_d, B_ed, B_e, B_i, log_file, connection, cursor), state = DISABLED)
B_d = Button(tk, text="Удалить", font = 'Arial, 13', command = lambda: del_data(tree, log_file, connection, cursor), state = DISABLED)
